...
<style type="text/css"> <%@include file="/CSS/register.css" %> </style>
<script type="text/javascript"> <%@include file="/JS/register.js" %> </script>


</head>
<body>
	<header><ul><li><a href="backtowelcome">BACK</a></ul></header>
	<div class="container">
